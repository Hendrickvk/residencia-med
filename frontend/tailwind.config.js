  ...
  theme: {
    extend: {
      colors: {
        ...
        pasta: {
          carvao: "var(--pasta-carvao)",
          grafite: "var(--pasta-grafite)",
          ardosia: "var(--pasta-ardosia)",
          indigo: "var(--pasta-indigo)",
          lavanda: "var(--pasta-lavanda)",
          lilas: "var(--pasta-lilas)",
          purpura: "var(--pasta-purpura)",
          ameixa: "var(--pasta-ameixa)",
          orquidea: "var(--pasta-orquidea)",
          vinho: "var(--pasta-vinho)",
          framboesa: "var(--pasta-framboesa)",
          rosa: "var(--pasta-rosa)",
          algodao: "var(--pasta-algodao)",
          ciano: "var(--pasta-ciano)",
          gelo: "var(--pasta-gelo)",
          turquesa: "var(--pasta-turquesa)",
          petroleo: "var(--pasta-petroleo)",
          oceano: "var(--pasta-oceano)",
          cafe: "var(--pasta-cafe)",
          chocolate: "var(--pasta-chocolate)",
        },
        "pasta-on": {
          carvao: "var(--pasta-carvao-on)",
          grafite: "var(--pasta-grafite-on)",
          ardosia: "var(--pasta-ardosia-on)",
          indigo: "var(--pasta-indigo-on)",
          lavanda: "var(--pasta-lavanda-on)",
          lilas: "var(--pasta-lilas-on)",
          purpura: "var(--pasta-purpura-on)",
          ameixa: "var(--pasta-ameixa-on)",
          orquidea: "var(--pasta-orquidea-on)",
          vinho: "var(--pasta-vinho-on)",
          framboesa: "var(--pasta-framboesa-on)",
          rosa: "var(--pasta-rosa-on)",
          algodao: "var(--pasta-algodao-on)",
          ciano: "var(--pasta-ciano-on)",
          gelo: "var(--pasta-gelo-on)",
          turquesa: "var(--pasta-turquesa-on)",
          petroleo: "var(--pasta-petroleo-on)",
          oceano: "var(--pasta-oceano-on)",
          cafe: "var(--pasta-cafe-on)",
          chocolate: "var(--pasta-chocolate-on)",
        },
        "pasta-soft": {
          carvao: "var(--pasta-carvao-soft)",
          grafite: "var(--pasta-grafite-soft)",
          ardosia: "var(--pasta-ardosia-soft)",
          indigo: "var(--pasta-indigo-soft)",
          lavanda: "var(--pasta-lavanda-soft)",
          lilas: "var(--pasta-lilas-soft)",
          purpura: "var(--pasta-purpura-soft)",
          ameixa: "var(--pasta-ameixa-soft)",
          orquidea: "var(--pasta-orquidea-soft)",
          vinho: "var(--pasta-vinho-soft)",
          framboesa: "var(--pasta-framboesa-soft)",
          rosa: "var(--pasta-rosa-soft)",
          algodao: "var(--pasta-algodao-soft)",
          ciano: "var(--pasta-ciano-soft)",
          gelo: "var(--pasta-gelo-soft)",
          turquesa: "var(--pasta-turquesa-soft)",
          petroleo: "var(--pasta-petroleo-soft)",
          oceano: "var(--pasta-oceano-soft)",
          cafe: "var(--pasta-cafe-soft)",
          chocolate: "var(--pasta-chocolate-soft)",
        },
      },
      fontFamily: {
